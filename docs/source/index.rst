...
The aiida-orca plugin for `AiiDA`_
=====================================================

``aiida-orca`` is available at http://github.com/aiidateam/aiida-orca
...
.. toctree::
   ...
   API documentation <apidoc/aiida_orca>
...
``aiida-orca`` is released under the MIT license.
