# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-orca
#
...
project = u'aiida-orca'
copyright_first_year = '2020'
copyright_owners = 'Pezhman Zarabadi-Poor'
...
release = aiida_orca.__version__
...
html_use_opensearch = 'http://aiida-orca.readthedocs.io'
...
htmlhelp_basename = 'aiida-orca-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_orca')
